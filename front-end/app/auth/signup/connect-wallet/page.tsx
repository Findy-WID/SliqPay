...
export default function ConnectWallet() {
  ...
  const handleContinue = () => {
    if (isConnected && address) {
      router.push("/auth/signup/create-login-details");
    }
  };
    ...
    <div className="min-h-screen bg-[#f7fbff] relative p-6">
      ...
      <div className="max-w-md mx-auto mt-8">
        ...
        <p className="text-sm text-gray-500">
          {isConnected ? "Wallet connected successfully" : "Connect your crypto wallet to continue"}
        </p>
        ...
        {isConnected ? (
          ...
          <div className="mt-6 inline-flex w-full items-center justify-center rounded-xl bg-gray-300 px-4 py-3 font-medium text-gray-500 cursor-not-allowed">
            Continue
          </div>
        )}
